...
"""autogenerated by genpy from RosAdapter/uwb_data.msg. Do not edit."""
import codecs
import sys
...
class uwb_data(genpy.Message):
  _md5sum = "2a9d6b1915268c02dadd546cc26931a6"
  _type = "RosAdapter/uwb_data"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint8         msgcnt
float64       u8x
float64       u8y
float64       u8z"""
  __slots__ = ['msgcnt','u8x','u8y','u8z']
