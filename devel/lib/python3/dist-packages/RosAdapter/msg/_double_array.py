...
"""autogenerated by genpy from RosAdapter/double_array.msg. Do not edit."""
import codecs
import sys
...
class double_array(genpy.Message):
  _md5sum = "788898178a3da2c3718461eecda8f714"
  _type = "RosAdapter/double_array"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(double_array, self).__init__(*args, **kwds)
